...
const DepartmentEmployeeFormGrid = ({updateEmployeeFormGridData, userReport}) => {
  const questions = [
    '1',
    '2',
    '3',
  ...
  const [formData, setFormData] = useState(userReport.employeeFormData ? userReport.employeeFormData : Array.from({ length: 6 }, () => ({ employeeTopJobDescription: '', supervisorRating: '', average: '', supervisorComment: '' })))
          ...
          {questions.map((question, index) => (
            <tr key={index} className='border-b border-black'>
              ...
              <td>
                <input
                  type="text"
                  value={userReport.employeeFormData[index].employeeTopJobDescription}
              ...
              <td>
                <input
                  type="number"
                  value={userReport.employeeFormData[index].supervisorRating}
...
export default DepartmentEmployeeFormGrid;