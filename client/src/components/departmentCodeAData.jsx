...
const DepartmentCodeConductA = ({updateCodeConductA, userReport}) => {
  const SN = [
    '1',
    '2',
    '3',
  ...
  const [formData, setFormData] = useState(userReport.codeAData ? userReport.codeAData : Array.from({ length: 7 }, () => ({ times: '', scores: '', description: ''})))
...
export default DepartmentCodeConductA