...
const DepartmentCodeConductB = ({updateCodeConductB, userReport}) => {
  const SN = [
    '1',
    '2',
    '3',
  ...
  const [formData, setFormData] = useState(userReport.codeBData ? userReport.codeBData : Array.from({ length: 7 }, () => ({ times: '', scores: '', description: ''})))
...
export default DepartmentCodeConductB
