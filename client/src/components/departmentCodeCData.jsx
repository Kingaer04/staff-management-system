...
const DepartmentCodeConductC = ({updateCodeConductC, userReport}) => {
  const SN = [
    '1',
    '2',
    '3',
  ...
  const [formData, setFormData] = useState(userReport.codeCData ? userReport.codeCData : Array.from({ length: 7 }, () => ({ times: '', scores: '', description: ''})))
...
export default DepartmentCodeConductC
