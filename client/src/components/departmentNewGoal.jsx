...
const DepartmentNewGoal = ({updateNewGoal, userReport}) => {
    const SN = [
        '1', '', '', '', '',
        '2', '', '', '', '',
        '3', '', '', '', ''
  ...
  const [formData, setFormData] = useState(userReport.newGoalData ? userReport.newGoalData : Array.from({ length: 15 }, () => ({ description: '' })));
...
export default DepartmentNewGoal
