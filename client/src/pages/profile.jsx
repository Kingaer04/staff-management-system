...
import { updateStart, updateSuccess, updateFailure, deleteUserStart, deleteUserSuccess, deleteUserFailure, signOutUserStart, signOutUserSuccess, signOutUserFailure } from '../redux/userSlice'
...
export default function Profile() {
  ...
  return (
    <div className='max-w-lg mx-auto'>
      <h1 className='text-3xl text-center font-semibold my-7' style={{ color: theme.palette.secondary[500] }}>Profile</h1>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input type="text" placeholder='UserName' className='border p-3 rounded-lg' id='userName' name='userName' value={formData.userName} onChange={handleChange} style={{ color: "#000" }}/>
        <input type="email" placeholder='Email' className='border p-3 rounded-lg' id='email' name='email' value={formData.email} onChange={handleChange} style={{ color: "#000" }}/>
        <input type="password" placeholder='OldPassword' className='border p-3 rounded-lg' id='oldPassword' name='oldPassword' onChange={handleChange} style={{ color: "#000" }}/> 
        <input type="password" placeholder='NewPassword' className='border p-3 rounded-lg' id='newPassword' name='newPassword'  onChange={handleChange} style={{ color: "#000" }}/>
